...
- **PR 5b pending**: SF1-vs-SEP authoritative-source resolution per ADR 0002 dec 13. New `get_marketcap` and `get_shares_outstanding` accessors return `attrs.frozen` flagged records (`value`, `source`, `estimated` flag).
