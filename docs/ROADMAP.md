...
- **PR 5c pending**: `IsMemberAt(t)` survivorship CLI demo at `examples/sp500_survivorship.py` per ADR 0002 M3 acceptance criterion 1 (2010 vs current S&P 500 count + survivor count + CAGR delta consistent with published survivorship-bias studies); CHANGELOG + ROADMAP + README flip to "M3 SHIPPED".
